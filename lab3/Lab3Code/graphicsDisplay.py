...
# Налаштування розмірів та кольорів
DEFAULT_GRID_SIZE = 17
INFO_PANE_HEIGHT = 35
BACKGROUND_COLOR = formatColor(0, 0, 0)
WALL_COLOR = formatColor(.9, 0, 0)
...
GHOST_COLORS.append(formatColor(.9, 0.13, 0.5))  # Pink
...
# Відмальовка панелі з інформацією
class InfoPane:
    ...
    # Переносимо відносну точку з нижнього лівого кута інформаційної області.
    ...
    # Рендеринг панелі із інформацією про рахунок гри
    def drawPane(self):
        self.scoreText = text(self.toScreen(0, 0), self.textColor, "SCORE:    0", "Times", self.fontSize, "bold")

    # Метод для оновлення рахунку гри на панелі
...
class PacmanGraphics:
    ...
    # Малюємо шлях Pac-man який був прорахований у методах пошуку шляху
    def drawExpandedCells(self, cells, r, g, b):
        for k, cell in enumerate(cells):
            screenPos = self.to_screen(cell)
            cellColor = formatColor(r, g, b)
    ...
    def drawAgentObjects(self, state):
        ...
        # Змінює зображення з привида на pac-man або навпаки (для захоплення)
    ...
    # Рендеринг Pac-man в залежності від сторони руху
    ...
    # Метот для отримання кольору привида
    ...
    # Метод для переміщення очей привида
    ...
    # Методя для опрацювання переміщення привида
    ...
    # Розташування анімованого агента на екрані
            ...
            for yNum, cell in enumerate(x):
                if cell:  # There's a wall here
                    ...
                    if nIsWall and eIsWall and (not neIsWall):
                        # outer circle
                        circle(add(screen, (self.gridSize * 2 * WALL_RADIUS, self.gridSize * (-2) * WALL_RADIUS)),
    ...
    # Метод для перевірки наявності стіни
